...
BIN = "/home/ru94wid/Dataset-1/z3/x64-gcc-7-O2_z3"
OUT = "/home/ru94wid/projects/angr-palmtree/evaluation/tokens/z3_x64-gcc-7-O2_z3.capstone.json"

def main():
    proj = angr.Project(BIN, auto_load_libs=False)

    # Key fix: disable indirect-jump resolution (avoids syscall_resolver path)
    ...
    max_functions = 200  # small sample for this step
    fn_count = 0
