...
class UsableTransformer:
    def __init__(self, model_path, vocab_path):
        ...
        # --- Minimal robust CUDA handling ---
        # USE_CUDA comes from config.py; torch.cuda.is_available() reflects actual runtime capability.
    ...
    def encode(self, text, output_option='lst'):
        ...
        # Keep your original return behavior (note: `if numpy:` is always True because numpy is a module).
        if self.use_cuda:
            if numpy:
